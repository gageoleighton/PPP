...
class protein():
    def __init__(self, name, sequence):
        ...
        if sequence:
            ...
            self.data = {'Name': self.name, 'Sequence': self.sequence, 'pI': self.pI, 'Extinction Reduced': self.extinction[0], 'Extinction Disulfide': self.extinction[1], 'Weight (KDa)': self.weight/1000, 'Aromaticity': self.aromaticity, 'AA Counts': self.aa_counts}
